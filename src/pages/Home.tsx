  ...
  return (
    <div className="relative overflow-hidden bg-black">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div
          className="absolute bottom-10 sm:bottom-20 right-5 sm:right-10 w-20 sm:w-40 h-20 sm:h-40 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-full blur-xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/4 w-12 sm:w-24 h-12 sm:h-24 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-full blur-xl animate-pulse"
      ...
      <section className="min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto text-center w-full">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white mb-6 sm:mb-8 leading-tight">
            ...
            <span
              className="block bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent animate-pulse"
              style={{ animationDelay: "0.5s" }}
            >
              DIGITAL
            </span>
            <span
              className="block bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent animate-pulse"
              style={{ animationDelay: "1s" }}
            >
              EMPIRES
            </span>
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in px-4">
            🚀 We don't just create websites - we forge digital experiences that{" "}
            <span className="text-cyan-400 font-bold">dominate markets</span>,
            <span className="text-purple-400 font-bold">
              {" "}
              captivate audiences
            </span>
            , and{" "}
            <span className="text-pink-400 font-bold">generate millions</span>.
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="text-center group cursor-pointer">
                  <div
                    className={`w-12 sm:w-16 lg:w-20 h-12 sm:h-16 lg:h-20 bg-gradient-to-r ${stat.gradient} rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-2 sm:mb-4 group-hover:scale-125 group-hover:rotate-12 transition-all duration-300 shadow-lg`}
                  >
                    <IconComponent className="w-6 sm:w-8 lg:w-10 h-6 sm:h-8 lg:h-10 text-white group-hover:animate-pulse" />
                  </div>
                  <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black text-white mb-1 sm:mb-2 group-hover:scale-110 transition-transform duration-300">
                    {stat.number}
                  </div>
                  <div className="text-xs sm:text-sm lg:text-base text-gray-400 group-hover:text-cyan-400 transition-colors duration-300">
                    {stat.label}
                  </div>
                </div>
              );
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto px-4">
              🔥 The digital services that make competitors cry and customers
              obsessed
            </p>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-r ${feature.gradient} rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 shadow-lg`}
                  >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-md border border-cyan-500/30 rounded-2xl sm:rounded-3xl p-8 sm:p-12 overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full">
              ...
              <div
                className="absolute bottom-2 sm:bottom-4 right-2 sm:right-4 w-4 sm:w-6 h-4 sm:h-6 bg-purple-400 rounded-full animate-ping"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute top-1/2 left-4 sm:left-8 w-3 sm:w-4 h-3 sm:h-4 bg-pink-400 rounded-full animate-ping"
                style={{ animationDelay: "2s" }}
              ></div>
            </div>
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-300 mb-6 sm:mb-8 relative z-10 px-4">
              💥 Let's build something that breaks the internet and makes your
              competitors jealous
            </p>
            <Link
              to="/contact"
