...
const ServiceEcommerce = () => (
  <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black pt-24 pb-20">
    ...
    <section className="max-w-4xl mx-auto px-4 text-center mb-12">
      <div className="flex flex-col items-center justify-center mb-6">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto">
          An online store opens your business to a global market, increases
          sales opportunities, and provides valuable customer insights.
          E-commerce solutions streamline operations, improve customer
          experience, and help you scale efficiently in the digital age.
        </p>
      </div>
    </section>
    {/* Features Grid */}
    ...
    <section className="text-center">
      <a
        href="/contact"
        className="inline-block bg-gradient-to-r from-orange-600 to-red-600 text-white px-10 py-4 rounded-full font-semibold shadow-lg hover:from-orange-700 hover:to-red-700 transition text-lg"
      >
        Get Started
      </a>
    </section>
