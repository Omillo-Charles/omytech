...
const ServiceWebDevelopment = () => (
  <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black pt-24 pb-20">
    ...
    <section className="max-w-4xl mx-auto px-4 text-center mb-12">
      <div className="flex flex-col items-center justify-center mb-6">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto">
          ...
          impression customers have of your business. A professionally designed
          and developed website builds trust, showcases your brand, and drives
          conversions. Responsive, fast, and secure web solutions ensure you
          reach your audience on any device, anytime.
        </p>
      </div>
    </section>
    {/* Features Grid */}
    ...
    <section className="text-center">
      <a
        href="/contact"
        className="inline-block bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-10 py-4 rounded-full font-semibold shadow-lg hover:from-cyan-700 hover:to-blue-700 transition text-lg"
      >
        Get Started
      </a>
    </section>
