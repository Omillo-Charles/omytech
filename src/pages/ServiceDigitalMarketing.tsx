...
const ServiceDigitalMarketing = () => (
  <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black pt-24 pb-20">
    ...
    <section className="max-w-4xl mx-auto px-4 text-center mb-12">
      <div className="flex flex-col items-center justify-center mb-6">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto">
          Digital marketing is essential for reaching new customers and growing
          your business online. With targeted strategies, you can increase brand
          awareness, drive traffic, and generate leads. Stay competitive and
          maximize your ROI with expert digital marketing services.
        </p>
      </div>
    </section>
    {/* Features Grid */}
    ...
    <section className="text-center">
      <a
        href="/contact"
        className="inline-block bg-gradient-to-r from-green-600 to-teal-600 text-white px-10 py-4 rounded-full font-semibold shadow-lg hover:from-green-700 hover:to-teal-700 transition text-lg"
      >
        Get Started
      </a>
    </section>
