  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive enterprise platform with advanced analytics, real-time collaboration, and seamless integrations.",
    ...
    },
    {
      ...
      description:
        "Revolutionary mobile banking app with AI-powered insights and biometric security.",
    ...
    },
    {
      ...
      description:
        "Multi-vendor marketplace with advanced search, AR try-on, and personalized recommendations.",
    ...
    },
    {
      ...
      description:
        "Real-time analytics dashboard with interactive visualizations and predictive modeling.",
    ...
    },
    {
      ...
      description:
        "Complete UI/UX design system for a travel planning and booking application.",
    ...
    },
    {
      ...
      description:
        "Comprehensive health monitoring app with wearable integration and AI coaching.",
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Explore our collection of successful projects that showcase
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Let's create something amazing together that will be the next
            showcase in our portfolio.
          </p>
          <Link
            to="/contact"
            className="bg-white text-blue-600 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-colors duration-200"
          >
            Start Your Project
          </Link>
        </div>
