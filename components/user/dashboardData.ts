...
export const activity = [
  {
    title: "New design files were shared",
    detail: "OMYTECH website · 2 hours ago",
    icon: FiFolder,
    color: "#0b78b7",
  },
  {
    title: "Milestone marked as complete",
    detail: "Mobile product discovery · Yesterday",
    icon: FiCheckCircle,
    color: "#26834b",
  },
  {
    title: "Invoice INV-004 is due soon",
    detail: "Due September 28, 2026",
    icon: FiCreditCard,
    color: "#b45c16",
  },
];
