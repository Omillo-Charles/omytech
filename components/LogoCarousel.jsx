    ...
    <section className="relative py-12 pb-24 overflow-hidden bg-[#0A0A0A]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-8">
          <p className="text-gray-500 text-[10px] md:text-sm font-glacial font-semibold uppercase tracking-wider">
            ...
            >
              {duplicatedCompanies.map((company, index) => (
                ...
                >
                  ...
                  />
                  <span className="text-gray-400 text-[10px] md:text-sm font-fira font-medium">
                    {company.name}
                  </span>
                </div>
              ))}
