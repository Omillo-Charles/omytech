...
export default function HomeHero() {
  ...
  return (
    <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 px-4 sm:px-6 md:px-8 bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-glacial font-bold text-white tracking-tight leading-[1.12] mb-6"
        >
        ...
        <motion.div
          ...
          className="relative max-w-5xl mx-auto mb-10 rounded-2xl sm:rounded-3xl border border-white/10 overflow-hidden bg-white/[0.02] shadow-[0_0_60px_rgba(0,114,206,0.15)] group"
        >
          <div className="relative w-full aspect-[16/9] sm:aspect-[16/8] overflow-hidden">
            <Image
              src="/hero_showcase.png"
              alt="OMYTECH Studio Web Development Showcase"
              fill
        ...
        {/* Call to Actions (Now Placed After the Hero Image) */}
        <motion.div
          initial={{ opacity: 0, y: 25 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto pt-6 border-t border-white/10"
        >
