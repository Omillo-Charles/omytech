...
import { FiArrowRight, FiGlobe, FiMail, FiMapPin, FiPhone } from 'react-icons/fi';
...
const socialLinks = [
    { label: 'Instagram', href: 'https://instagram.com/omyt3ch', icon: FaInstagram },
            ...
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="grid gap-8 sm:gap-10 md:grid-cols-2 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1.2fr]">
                    <div>
                        ...
                        >
                            Helping businesses grow through modern web platforms, mobile applications, and digital
                            innovation built for real-world impact.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            {footerLinks.company.map((item) => (
                                <li key={item.label}>
                                    <a href={item.href} className="opacity-80 transition hover:opacity-100" style={{ color: colors.white }}>
                                        {item.label}
                                    </a>
                                </li>
                            ))}
