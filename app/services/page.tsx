        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:gap-16 lg:px-8">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-[#536579] sm:text-lg">
              From your first website to a complete digital ecosystem, we help
              businesses build, launch, and grow with technology that makes
              sense.
            </p>
            <a
              href="/contact"
          ...
          <div className="border border-[#cfe0ee] bg-white p-6 shadow-[0_18px_50px_rgba(7,26,45,0.07)] sm:p-8">
            <div className="flex items-center gap-3 border-b border-[#e6eef5] pb-5">
              <div
                className="flex h-11 w-11 items-center justify-center bg-[#eef6fb]"
                style={{ color: colors.primary }}
              >
            ...
            <p className="pt-5 text-sm leading-7 text-[#536579]">
              We bring the right mix of creative thinking and technical
              execution to every project, whether you need one focused service
      ...
      <section className="py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-5 sm:mt-12 sm:grid-cols-2 lg:grid-cols-4">
            {services.map(
              ({ number, title, description, icon: Icon, tags }) => (
                <article
                  key={title}
