...
const values = [
  {
    ...
    description:
      "We make technology easier to understand, use, and act on, for both your team and your customers.",
    icon: FiCompass,
  },
  {
    title: "Purpose before polish",
    description:
      "Good design should look considered, but it should work even harder behind the scenes.",
    icon: FiTarget,
  },
  {
    title: "Built for the long run",
    description:
      "We create flexible foundations that can support your next stage, not just your next launch.",
    icon: FiLayers,
  },
  {
    title: "People at the centre",
    description:
      "The best digital products respect people’s time, context, goals, and everyday reality.",
    icon: FiHeart,
  },
];
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16 lg:px-8">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-[#536579] sm:text-lg">
              OMYTECH Kenya helps ambitious businesses use digital tools with
              more confidence. We combine strategy, design, development, and
              growth thinking to turn good ideas into useful experiences.
            </p>
            <a
              href="/contact"
      ...
      <section className="py-16 sm:py-20 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-start lg:gap-20 lg:px-8">
          ...
          <div className="space-y-5 text-base leading-8 text-[#536579] sm:text-lg">
            <p>
              Too many digital projects begin with a tool and end with a system
              nobody enjoys using. We believe the starting point should be
              different: understand the people, the pressure, and the
              opportunity first.
            </p>
            <p>
              That is why our work brings business thinking and technology
              together. Whether we are shaping a brand presence, building
              software, or helping a team grow online, we focus on making the
              next step clearer and more valuable.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-5 sm:mt-12 sm:grid-cols-2 lg:grid-cols-4">
            {values.map(({ title, description, icon: Icon }) => (
              <article
                key={title}
                className="border border-[#dce5ef] bg-white p-6 shadow-[0_12px_35px_rgba(7,26,45,0.05)] sm:p-7"
              >
                <div
                  className="flex h-12 w-12 items-center justify-center bg-[#e8f6fc]"
                  style={{ color: colors.primary }}
                >
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:gap-20 lg:px-8">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-8 text-[#536579]">
              The strongest results come from good collaboration. We keep
              communication open, decisions grounded, and the work connected to
          ...
          <div className="border border-[#dce5ef] bg-[#f5f8fc] p-6 sm:p-8">
            <div className="mb-6 flex items-center gap-3 border-b border-[#dce5ef] pb-5">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-[#6b7d90]">
                  From first conversation to beyond launch
                </p>
              </div>
            </div>
            <ul className="space-y-4">
              {commitments.map((commitment) => (
                ...
                >
                  <span
                    className="mt-1 h-2 w-2 shrink-0 bg-[#0b78b7]"
                    aria-hidden="true"
                  />
                  {commitment}
                </li>
